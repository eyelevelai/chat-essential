...
1. Customize your GPT-3 powered virtual assistant by configuring what website content and knowledge kits to use.
2. Deploy the chat to your website or generate a QR code that launches a chat when scanned.
3. Configure which US phone number you live chat with customers from and which email receives chat transcripts.
